...
final class TextTest extends TestCase
{
    ...
    {
        self::assertLessThan($length, mb_strlen($this->faker->realText($length)));
    }
    ...
    {
        self::assertGreaterThanOrEqual($length * 0.8, mb_strlen($this->faker->realText($length)));
    }
    ...
    {
        $strlen = mb_strlen($this->faker->realTextBetween($min, $max));
